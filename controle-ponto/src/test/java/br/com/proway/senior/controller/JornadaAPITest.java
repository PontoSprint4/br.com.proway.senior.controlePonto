...
class JornadaAPITest {
	...
	public void getTodasJornadasDaPessoaTest() throws Exception {
		...
		assertEquals(3,jornadaApi.getTodasJornadasDaPessoa(idPessoa).size());
	}
	...
	public void getJornadasDaPessoaPorPeriodoTest() throws Exception {
		...
		assertEquals(
			2,jornadaApi.getJornadasDaPessoaPorPeriodo(idPessoa, LocalDate.of(2021, 8, 1), LocalDate.of(2021, 8, 20)).size());
	}
	...
	public void getJornadaDaPessoaNoDiaTest() throws Exception {
		...
		assertNotNull(jornadaApi.getJornadaDaPessoaNoDia(idPessoa, LocalDate.of(2021, 8, 12)));
	}
	...
	public void getHorasTrabalhadasDaPessoaPorPeriodo() throws Exception {
		...
		assertEquals(6*60 ,jornadaApi.getHorasTrabalhadasDaPessoaPorPeriodo(idPessoa, LocalDate.of(2021, 8, 1), LocalDate.of(2021, 8, 30)));
	}
